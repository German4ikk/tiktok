...
export const LINKS_CONFIG: LinkItem[] = [
  ...
  { id: 'donate', href: 'https://buymeacoffee.com/digital_expert', textKey: 'buttonDonate', icon: React.createElement(EuroIcon, null), primary: true },
...
export const SOCIAL_LINKS_CONFIG: SocialLink[] = [
  { id: 'telegram_footer', href: 'https://t.me/bonez_mc187', icon: React.createElement(TelegramIcon, {className: "w-5 h-5"}), label: 'Telegram' },
  { id: 'youtube_footer', href: 'https://www.youtube.com/@RealDiamondLife', icon: React.createElement(YouTubeIcon, {className: "w-5 h-5"}), label: 'YouTube' },
  { id: 'instagram_footer', href: 'https://www.instagram.com/digital_expert_ee?igsh=MXA0cDVvdHVic25mNA==', icon: React.createElement(InstagramIcon, {className: "w-5 h-5"}), label: 'Instagram' },
];
